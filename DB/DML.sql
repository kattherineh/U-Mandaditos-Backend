...
INSERT INTO [Media] (Name, Link) VALUES
('Media1', 'https://example.com/media1'),
...
INSERT INTO [OrderStatus] (Name, Active) VALUES
('En proceso', 1),
('Entregado', 1),
('No entregado', 1);

INSERT INTO [UserRoles] (Name, Active) VALUES
('Poster', 1),
('Runner', 1);

INSERT INTO [Users] (Name, DNI, Email, Password, BirthDay, Rating, IdProfilePic, IdLastLocation, IdCareer) VALUES
('Juan Perez', '12345678', 'juan.perez@example.com', 'password123', '1990-05-15', 4, 1, 1, 5),
...
INSERT INTO [Posts] (Description, SuggestedValue, IdPosterUser, IdPickupLocation, IdDeliveryLocation, CreatedAt, Completed) VALUES
('Pizza Margarita', 15.50, 1, 2, 5, '2023-01-10 09:00:00', 1),
...
INSERT INTO [Offers] (CounterOfferAmount, IdPost, IdUserCreator, CreatedAt, IsCounterOffer, Accepted) VALUES
(15.50, 1, 2, '2023-01-12 10:15:30', 0, 1), -- Igual al SuggestedValue del Post 1
...
VALUES
('ABC123', '2023-01-12 10:30:00', '2023-01-12 12:00:00', 1, 1, 15.50), -- IdPost 1, IdOffer 1
...
INSERT INTO Rating (IdMandadito, IdRater, IdRatedUser, Rating, Review, IdRatedRole, CreatedAt)
VALUES
(1, 2, 1, 5, '¡Excelente servicio! Todo llegó a tiempo y en perfecto estado.', 1, '2023-01-12 12:30:00'), -- IdMandadito 1, IdRatedRole 1 (cliente)
(1, 1, 2, 4, 'Muy amable y puntual. ¡Lo recomiendo!', 2, '2023-01-12 12:35:00'), -- IdMandadito 1, IdRatedRole 2 (repartidor)
(2, 3, 2, 3, 'Buen servicio, pero hubo un pequeño retraso.', 1, '2023-02-16 16:15:00'), -- IdMandadito 2, IdRatedRole 1 (cliente)
(2, 2, 3, 5, 'Todo perfecto, muy profesional.', 2, '2023-02-16 16:20:00'), -- IdMandadito 2, IdRatedRole 2 (repartidor)
(3, 4, 3, 4, 'Muy buen trato, pero el paquete llegó un poco golpeado.', 1, '2023-03-21 10:45:00'), -- IdMandadito 3, IdRatedRole 1 (cliente)
(3, 3, 4, 5, 'Excelente comunicación y servicio.', 2, '2023-03-21 10:50:00'), -- IdMandadito 3, IdRatedRole 2 (repartidor)
(4, 5, 4, 2, 'El servicio fue lento y no cumplió con lo esperado.', 1, '2023-04-26 18:30:00'), -- IdMandadito 4, IdRatedRole 1 (cliente)
(4, 4, 5, 3, 'Cumplió, pero podría mejorar en puntualidad.', 2, '2023-04-26 18:35:00'), -- IdMandadito 4, IdRatedRole 2 (repartidor)
(5, 6, 5, 5, '¡Increíble! Todo perfecto y muy rápido.', 1, '2023-05-31 13:15:00'), -- IdMandadito 5, IdRatedRole 1 (cliente)
(5, 5, 6, 4, 'Muy buen servicio, pero el trato podría ser más amable.', 2, '2023-05-31 13:20:00'); -- IdMandadito 5, IdRatedRole 2 (repartidor)